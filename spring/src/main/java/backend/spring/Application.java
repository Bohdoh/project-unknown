...
public class Application {
    ...
    public void dummyData() {
        ...
        chapterRepository.save(new Chapter(gameRepository.findByTitle("Die Jagd nach dem London-Killer"),
                readImage("spring" + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "static" + File.separator + "images" + File.separator + "chapterimages" + File.separator + "jagdnachdemlondonkiller" + File.separator + "BakerStreetFrauImRotenKleidNeuAngepasst.jpg"),
    ...
    private void create6DummyGames() {
        if (gameRepository.count() == 0) {
            ...
            gameRepository.save(new Game("The Quest for the Lost City", "The player takes on the role of an adventurer on a mission to uncover the secrets of a long-lost city, facing challenges and making decisions that determine the outcome of their quest", "\"The Quest for the Lost City\" is a text adventure game where the player takes on the role of an adventurer on a mission to uncover the secrets of a long-lost city, facing challenges and making decisions that determine the outcome of their quest", readImage("spring" + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "static" + File.separator + "images" + File.separator + "image1.jpeg"), enduserRepository.findByEnduserId(1)));
            gameRepository.save(new Game("Echoes of the Ancients", " The player explores mysterious ruins of an ancient civilization, solving puzzles and deciphering ancient texts to uncover the secrets of the lost civilization and its downfall", " a text adventure game where the player explores mysterious ruins of an ancient civilization, solving puzzles and deciphering ancient texts to uncover the secrets of the lost civilization and its downfall", readImage("spring" + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "static" + File.separator + "images" + File.separator + "image2.jpeg"), enduserRepository.findByEnduserId(2)));
            gameRepository.save(new Game("The Enchanted Woods", " The player sets out on a journey through a mystical forest, encountering magical creatures, solving riddles and navigating through challenging terrain", "a text adventure game where the player sets out on a journey through a mystical forest, encountering magical creatures, solving riddles and navigating through challenging terrain, all while trying to uncover the mystery of the forest and its enchantment", readImage("spring" + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "static" + File.separator + "images" + File.separator + "image3.jpeg"), enduserRepository.findByEnduserId(3)));
            gameRepository.save(new Game("Das Labyrinth der Dunkelheit", " Der Spieler muss sich durch ein dunkles Labyrinth navigieren, um zu entkommen. Dabei trifft er auf verschiedene Herausforderungen und Hindernisse", "ein Text-Adventure-Spiel, bei dem der Spieler sich durch ein dunkles Labyrinth navigieren muss, um zu entkommen. Dabei trifft er auf verschiedene Herausforderungen und Hindernisse, löst Rätsel und muss sich gegen unerwartete Gefahren verteidigen", readImage("spring" + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "static" + File.separator + "images" + File.separator + "image4.jpeg"), enduserRepository.findByEnduserId(4)));
            gameRepository.save(new Game("Das Geheimnis des verschollenen Schatzes", " Der Spieler übernimmt die Rolle eines Schatzsuchers, der sich auf die Suche nach einem verschollenen Schatz begibt", "ein Text-Adventure-Spiel, bei dem der Spieler die Rolle eines Schatzsuchers übernimmt, der sich auf die Suche nach einem verschollenen Schatz begibt", readImage("spring" + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "static" + File.separator + "images" + File.separator + "image5.jpeg"), enduserRepository.findByEnduserId(5)));
            gameRepository.save(new Game("Die Jagd nach dem London-Killer", "Reise zurück in die Zeit und helfe einem aufstrebenden Medizinstudenten bei der Suche nach dem London-Killer", "Du wirst zu einem Abendessen in die Villa des Dr. von Arroganz eingeladen - unwissend, was dich daraufhin erwartet. Begleite den jungen Mann auf seiner Reise und stelle dich allen Hindernissen, um den London-Killer zu fassen. ", readImage("spring" + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "static" + File.separator + "images" + File.separator + "chapterimages" + File.separator + "jagdnachdemlondonkiller" + File.separator + "BakerStreetTitelbild.jpg"), enduserRepository.findByEnduserId(1)));
